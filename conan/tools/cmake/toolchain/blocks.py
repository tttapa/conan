    ...
    template = textwrap.dedent("""\
        ...
        foreach(config IN LISTS CMAKE_CONFIGURATION_TYPES)
            ...
            if(DEFINED CONAN_SHARED_LINKER_FLAGS_${config})
              ...
              string(APPEND CMAKE_MODULE_LINKER_FLAGS_${config}_INIT " ${CONAN_SHARED_LINKER_FLAGS_${config}}")
            endif()
        ...
        if(DEFINED CONAN_SHARED_LINKER_FLAGS)
          ...
          string(APPEND CMAKE_MODULE_LINKER_FLAGS_INIT " ${CONAN_SHARED_LINKER_FLAGS}")
        endif()
